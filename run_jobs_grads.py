...
configs = itertools.product(seeds,[args.env_name],[args.project_name],
                            ...
                            [args.num_critics],[args.on_policy_data],[args.discount_entropy],[args.discount_actor],[args.entropy_coeff],[args.max_episode_steps],[args.healthy_reward],[args.use_momentum])
