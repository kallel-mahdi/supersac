...
parser.add_argument('--hidden_dims', type=int, default=256, help="list of hidden dimensions")
parser.add_argument('--anneal_lr', type=str2bool, default=False, help="whether to anneal the learning rate")
